...
### Consuming s2n-tls through CMake
s2n-tls ships with modern CMake finder scripts if you use CMake for the build. To take advantage of this from your CMake script, all you need to do to compile and link against s2n-tls in your project is:
...
Once built, the static and dynamic libraries for s2n-tls are available in the lib/
directory.

## Building s2n-tls with BoringSSL

To build s2n-tls with BoringSSL, you must check out a copy of the BoringSSL
directly using git. This procedure has been tested with
...
Once built, static and dynamic libraries for s2n-tls are available in the lib/
directory.
...
The API exposed by s2n-tls is the set of functions and declarations in the "s2n.h" header file. Any functions and declarations that are in the "s2n.h" file
...
**s2n_blinding** is used to opt-out of s2n-tls built-in blinding. Blinding is a
...
s2n-tls defines several opaque structures used for managed objects. Because
